      ...
      <section class="studio-workspace">
        ...
        <div class="studio-canvas">
            ...
            <div class="matrix-preview__grid">
              <For each={Array.from({ length: 40 })}>
                {(_, index) => (
                  <span
                    classList={{
                      "is-on": [1, 8, 14, 19, 27, 34].includes(index()),
                    }}
                  />
                )}
              </For>
          ...
          <div class="studio-empty">
            <span
              class="studio-empty__glyph icon i-ri-sound-module-line"
              aria-hidden="true"
            />
            <div>
              <h2>Studio is in preview.</h2>
              <p>
                Editing and playback are not connected yet. This preview shows
                the Matrix workspace while the Rust engine is added.
              </p>
            </div>
