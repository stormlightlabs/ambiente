    ...
    <>
      <section class="hero">
        <div class="hero__copy">
          ...
          <p class="hero__lede">
            Play a phrase or draw a pattern, then shape how it repeats,
            transforms, and varies. Ambiente keeps each result repeatable.
          </p>
      ...
      <section class="principle-band">
        <blockquote>
          “A musician should be able to author recognizable material, let it
          evolve, and return to the same realization later.”
        </blockquote>
