...
import { AmbientInstrumentType, type Preset } from "$lib/types/presets";
...
export const AMBIENT_TO_ENGINE_MAPPING: Record<AmbientInstrumentType, InstrumentType> = {
  ...
  [AmbientInstrumentType.FieldRecording]: InstrumentType.FieldRecording,
  [AmbientInstrumentType.VocalPad]: InstrumentType.VocalPad,
  [AmbientInstrumentType.Arpeggiator]: InstrumentType.Arpeggiator,
};
