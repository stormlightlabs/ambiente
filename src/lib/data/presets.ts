...
export const PRESETS: Preset[] = [{
  ...
  config: {
    ...
    mode: Mode.Aeolian,
    volume: 0.65,
    instruments: new SvelteSet([InstrumentType.AmbientPad, InstrumentType.Granular, InstrumentType.Melodic, InstrumentType.VocalPad]),
  },
  texture: {
    name: "Cosmic Voyage",
    tempo: 68,
  ...
  config: {
    ...
    mode: Mode.Dorian,
    volume: 0.6,
    instruments: new SvelteSet([InstrumentType.AmbientPad, InstrumentType.Granular, InstrumentType.HarmonicDrone, InstrumentType.FieldRecording]),
  },
  texture: {
    name: "Ancient Forest",
    tempo: 75,
  ...
  config: {
    ...
    mode: Mode.Ionian,
    volume: 0.65,
    instruments: new SvelteSet([InstrumentType.AmbientPad, InstrumentType.Melodic, InstrumentType.HarmonicDrone, InstrumentType.Arpeggiator]),
  },
  texture: {
    name: "Gentle Current",
    tempo: 80,
